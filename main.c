...
void main(void) {
   ...
   // Initialize IOs for low-power wake-up
    ...
    while(1)
    {
        ...
        /*-- UART DISPLAY COMMANDS - USED FOR UART TX DEMO --*/
        ...
        char str2[10];
        d =-58;                       
        sprintf(str2, "%1.0d", d);     // translates -15.5678 into array of char called str[]    
        Disp2String(str2);             //Display str[]
        XmitUART2('\n',1);            // Xmits New line ASCII command via UART2
        XmitUART2('\r',1);            // Xmits Carriage Return ASCII command via UART2

     
        
        /*-- UART RECEIVE COMMANDS - USED FOR UART RX DEMO --*/
//        UARTRxChar = RxUART2();
//        XmitUART2(UARTRxChar,1);
//        LATBbits.LATB8 = 1;             //Turn on LED
//        Idle();                       // Put MCU in idle mode - UART RX will interrupt
...
//        XmitUART2(' ', 1);
        ...
        /*-- SEND 16 BIT INT VIA UART - USED FOR PYTHON DEMO WITH PythonUARTRxUINT16_Demo2.py --*/
//        uint16_t ctr = 0;
//        while(ctr <= 65535)
//        {
//            Disp2Dec(ctr);
...
//        }
        ...
        /*-- SEND 16 BIT INT AND FLOAT VIA UART - USED FOR PYTHON DEMO WITH PythonUARTRxIntFloat_Demo3.py --*/
//        double f;    // Send float number first
//        char str[10];
//        f= -15.56788;
//        sprintf(str, "%1.3f", f); // translates -15.5678 into array of char called str[]]
//        Disp2String(str);         //Display str[]
//        XmitUART2(' ',1);
//        XmitUART2('\n',1);        // Xmits New line ASCII command via UART2
        
//        Disp2Dec(i);   // send decmimal number next
//        i = i+1;
//        if (i==100)
//            {i = 0;}
//        XmitUART2('\n',1);
